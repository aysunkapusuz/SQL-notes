/* Database is any collection of related information
   ...
   Two types of DB's, Relational and Non-Relational
   ...
   Queries are requests made to the db management system for specific information
   A google search is  is a query. */
